#!/usr/bin/env python3
"""
Script para autenticar e inserir os 2 novos artigos do blog no Supabase
"""
...
USER_EMAIL = "cjvj0210@gmail.com"
USER_PASSWORD = "02101122"
...
def insert_article(article, access_token):
    """Insere um artigo no Supabase usando o token de acesso"""
    headers = {
        "apikey": SUPABASE_KEY,
...
if __name__ == "__main__":
    print("=" * 60)
    print("Inserindo artigos no Supabase com autenticação...")
    print("=" * 60)
    ...
    if access_token:
        ...
        insert_article(artigo_dor_costas, access_token)
        
        # Inserir artigo 2
        print("\n📝 Inserindo artigo: Prevenção de Quedas em Idosos...")
        insert_article(artigo_prevencao_quedas, access_token)
