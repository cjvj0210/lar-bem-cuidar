...
import { Heart, Shield, TrendingUp, Activity, CheckCircle2, Phone, Quote, Star, ArrowRight, Check, Calendar } from "lucide-react";
        ...
        <section className="section-padding bg-muted/30">
          <div className="container-custom max-w-4xl">
              ...
              <Card className="border-2 border-primary bg-primary/5">
                <CardContent className="pt-8 pb-8">
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
                      <span>1x, 2x ou 3x por semana</span>
                    </li>
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
                    ...
                    <li className="flex items-start gap-2">
                      <Check className="w-4 h-4 text-green-600 flex-shrink-0 mt-0.5" />
                      <span>Economia em planos intensivos</span>
                    </li>
                  </ul>
                </CardContent>
              </Card>
            ...
            <p className="text-sm text-muted-foreground text-center mt-8">
              *Os valores variam de acordo com o tratamento e frequência. Entre em contato via WhatsApp para informações personalizadas sobre investimento.
            </p>
          </div>
        </section>
        <section className="section-padding">
